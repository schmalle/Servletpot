 ...
 * Time: 7:00:28 PM
 */
public class VulnEmulatorNetty
{
	 ...
	 * @param reqNr
	 */
    public VulnEmulatorNetty(ConfigHandler cf, Utils u, Logger l, int reqNr)
    {
     ...
     */
    public String checkForNewAttack(Hashtable get, Hashtable post, String URI, int reqNr, String host, String method, String ip)
...

    {
		...
		{
			m_uriStore.remove((Object)shortURI);
			return null;
		}


		String getStrings = checkForNewAttackInternal(get, get, URI, reqNr, host, method, ip);
		if (getStrings != null)
			return getStrings;

		return checkForNewAttackInternal(post, post, URI, reqNr, host, method, ip);
     ...
     *   @out: null if nothing found
     */
    public String checkForNewAttackInternal(Hashtable get, Hashtable post, String URI, int reqNr, String host, String method, String ip)


    {


        Enumeration paramNames = get.keys();
        ...
        if (paramNames != null)
        {
            while (paramNames.hasMoreElements())
            {
                ...
                String parameter = (String)get.get(paramName);
                        ...
                        if ((parameter != null) && (attackType = attackCheck(parameter, URI)) != null)
                        {
                            ...
                            m_l.log("Info: " + attackType + "from IP: " + ip + " at time " + new Date().toString() + " and " + method + " request " + URI + parameter, reqNr);
        ...
        m_l.log("Info: Found no attack in " + method + " request " + URI + " from IP: " + ip + " at time " + new Date().toString(), reqNr );


        // nothing found
        return null;
    }    // checkForNewAttackInternal
     ...
     */
    public String handleRequest(String URI, Hashtable get, Hashtable post, String ip, int reqNr, String host, String method)
    {

        URI = URI.toLowerCase();

        // reaching this points means that an RFI attack was ...
        return checkForNewAttack(get, post, URI, reqNr, host,  method, ip);
