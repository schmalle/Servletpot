...
public class MySqlHibernate implements DBAccess
{
	...
	public boolean existsURI(long hash, long len, int reqNr)
	{
		...
		{
			if (m_l != null)
				m_l.log("ServletPot.existsURI: Error at database handling....".concat(e.toString()), reqNr);
	...
	public boolean existsFile(long len, long crc32, int reqNr)
	{
		...
		{
			if (m_l != null)
				m_l.log("ServletPot.existsFile: Error at database handling....".concat(e.toString()), reqNr);
		}
